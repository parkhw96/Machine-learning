...
- ### Large margin intuition
  ...
  ![image-20210521132842917](C:\Users\korea\AppData\Roaming\Typora\typora-user-images\image-20210521132842917.png)
...
- ### Kernels 2
  ...
  ![image-20210521142405286](C:\Users\korea\AppData\Roaming\Typora\typora-user-images\image-20210521142405286.png)

  ##### 이제 새로운 예제가 들어오게 되면 f0부터 fm까지의 값들을 모두 계산할 수 있다. (f0는 항상 1)

  ##### 이제 feature x를 feature f로 대체하기 위해서 아래와 같이 계산한다. 다시 말하면 (x^i, y^i)의 예제가 있다면, x^i는 아래와 같이 계산될 수 있다. x^i도 m개, f^i도 m개 이다.
  ...
  ![image-20210521143710828](C:\Users\korea\AppData\Roaming\Typora\typora-user-images\image-20210521143710828.png)
